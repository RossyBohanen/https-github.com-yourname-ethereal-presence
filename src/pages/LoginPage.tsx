        ...
        <div className="bg-slate-800/50 backdrop-blur-lg rounded-2xl border border-slate-700/50 p-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="flex items-center justify-center gap-3 px-4 py-3 bg-slate-900/50 border border-slate-600/50 rounded-lg text-slate-300 hover:bg-slate-700/50 hover:border-slate-500/50 transition-colors"
            >
