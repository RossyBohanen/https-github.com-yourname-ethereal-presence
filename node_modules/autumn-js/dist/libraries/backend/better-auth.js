...
var AttachFeatureOptionsSchema2 = import_v49.z.object({
  featureId: import_v49.z.string(),
  quantity: import_v49.z.number()
});
var AttachParamsSchema2 = import_v49.z.object({
  productId: import_v49.z.string().optional(),
  entityId: import_v49.z.string().optional(),
  options: import_v49.z.array(AttachFeatureOptionsSchema2).optional(),
  productIds: import_v49.z.array(import_v49.z.string()).optional(),
  freeTrial: import_v49.z.boolean().optional(),
  successUrl: import_v49.z.string().optional(),
  metadata: import_v49.z.record(import_v49.z.string(), import_v49.z.string()).optional(),
  forceCheckout: import_v49.z.boolean().optional(),
  /**
   * @deprecated This field is deprecated and will be removed in a future version.
   */
  dialog: import_v49.z.any().optional().describe(
    "DEPRECATED: This field is deprecated and will be removed in a future version. Please use the checkout() method instead."
  ),
  entityData: import_v49.z.any().optional(),
  openInNewTab: import_v49.z.boolean().optional(),
  reward: import_v49.z.string().optional(),
  checkoutSessionParams: import_v49.z.record(import_v49.z.string(), import_v49.z.any()).optional()
});
var CheckoutParamsSchema2 = import_v49.z.object({
  productId: import_v49.z.string().optional(),
  productIds: import_v49.z.array(import_v49.z.string()).optional(),
  entityId: import_v49.z.string().optional(),
  entityData: import_v49.z.any().optional(),
  ...
  successUrl: import_v49.z.string().optional(),
  openInNewTab: import_v49.z.boolean().optional(),
  dialog: import_v49.z.any().optional(),
  forceCheckout: import_v49.z.boolean().optional(),
  freeTrial: import_v49.z.boolean().optional(),
  checkoutSessionParams: import_v49.z.record(import_v49.z.string(), import_v49.z.any()).optional(),
  reward: import_v49.z.string().optional()
...
var CreateEntityParamsSchema = import_v410.z.object({
  id: import_v410.z.string(),
  name: import_v410.z.string().optional(),
  featureId: import_v410.z.string()
});
var GetEntityParamsSchema = import_v410.z.object({
  expand: import_v410.z.array(import_v410.z.string()).optional()
});
var EntityDataParamsSchema = import_v410.z.object({
  name: import_v410.z.string().optional(),
  featureId: import_v410.z.string()
});
...
var CancelParamsSchema2 = import_v411.z.object({
  productId: import_v411.z.string(),
  entityId: import_v411.z.string().optional(),
  cancelImmediately: import_v411.z.boolean().optional()
});
var CheckParamsSchema2 = import_v411.z.object({
  featureId: import_v411.z.string().optional(),
  productId: import_v411.z.string().optional(),
  entityId: import_v411.z.string().optional(),
  requiredBalance: import_v411.z.number().optional(),
  sendEvent: import_v411.z.boolean().optional(),
  withPreview: import_v411.z.boolean().optional(),
  dialog: import_v411.z.any().optional(),
  entityData: import_v411.z.any().optional(),
  properties: import_v411.z.record(import_v411.z.string(), import_v411.z.any()).optional()
});
var TrackParamsSchema2 = import_v411.z.object({
  featureId: import_v411.z.string().optional(),
  eventName: import_v411.z.string().optional(),
  entityId: import_v411.z.string().optional(),
  value: import_v411.z.number().optional(),
  idempotencyKey: import_v411.z.string().optional(),
  entityData: import_v411.z.any().optional()
});
var OpenBillingPortalParamsSchema = import_v411.z.object({
  returnUrl: import_v411.z.string().optional(),
  openInNewTab: import_v411.z.boolean().optional()
});
var SetupPaymentParamsSchema = import_v411.z.object({
...
var QueryParamsSchema2 = import_v411.z.object({
  featureId: import_v411.z.string().or(import_v411.z.array(import_v411.z.string())),
  range: QueryRangeEnum.optional()
});

// src/libraries/react/client/types/clientReferralTypes.ts
var import_v412 = require("zod/v4");
var CreateReferralCodeParamsSchema2 = import_v412.z.object({
  programId: import_v412.z.string()
});
var RedeemReferralCodeParamsSchema2 = import_v412.z.object({
...
var addGenRoutes = (router2) => {
  (0, import_rou3.addRoute)(router2, "POST", `${BASE_PATH}/checkout`, {
    handler: checkoutHandler
  });
  (0, import_rou3.addRoute)(router2, "POST", `${BASE_PATH}/attach`, {
    handler: attachHandler
  });
  (0, import_rou3.addRoute)(router2, "POST", `${BASE_PATH}/cancel`, {
    handler: cancelHandler
  });
  (0, import_rou3.addRoute)(router2, "POST", `${BASE_PATH}/check`, {
    handler: checkHandler
  });
  (0, import_rou3.addRoute)(router2, "POST", `${BASE_PATH}/track`, {
    handler: trackHandler
  });
  (0, import_rou3.addRoute)(router2, "POST", `${BASE_PATH}/billing_portal`, {
    handler: openBillingPortalHandler
  });
  (0, import_rou3.addRoute)(router2, "POST", `${BASE_PATH}/setup_payment`, {
    handler: setupPaymentHandler
  });
  (0, import_rou3.addRoute)(router2, "POST", `${BASE_PATH}/query`, {
...
var addEntityRoutes = async (router2) => {
  (0, import_rou32.addRoute)(router2, "POST", "/api/autumn/entities", {
    handler: createEntityHandler
  });
  (0, import_rou32.addRoute)(router2, "GET", "/api/autumn/entities/:entityId", {
    handler: getEntityHandler
  });
  (0, import_rou32.addRoute)(router2, "DELETE", "/api/autumn/entities/:entityId", {
...
var addReferralRoutes = async (router2) => {
  (0, import_rou33.addRoute)(router2, "POST", `${BASE_PATH}/referrals/code`, {
    handler: createReferralCodeHandler
  });
  (0, import_rou33.addRoute)(router2, "POST", `${BASE_PATH}/referrals/redeem`, {
...
var createRouterWithOptions = () => {
  const router2 = (0, import_rou35.createRouter)();
  (0, import_rou35.addRoute)(router2, "POST", `${BASE_PATH}/cors`, {
    handler: () => {
      return {
        body: {
          message: "OK"
  ...
  (0, import_rou35.addRoute)(router2, "POST", `${BASE_PATH}/customers`, {
    handler: createCustomerHandler
  });
  (0, import_rou35.addRoute)(router2, "GET", `${BASE_PATH}/components/pricing_table`, {
    handler: getPricingTableHandler,
    requireCustomer: false
  });
  addGenRoutes(router2);
      ...
      createCustomer: (0, import_better_call.createEndpoint)(
        "/autumn/customers",
        {
          ...
          body: import_v413.z.object({
            errorOnNotFound: import_v413.z.boolean().optional(),
            expand: import_v413.z.array(CustomerExpandEnum).optional()
          }),
          metadata: {
            isAction: false
          }
