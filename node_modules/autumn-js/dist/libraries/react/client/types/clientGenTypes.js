...
var CancelParamsSchema2 = import_v49.z.object({
  productId: import_v49.z.string(),
  entityId: import_v49.z.string().optional(),
  cancelImmediately: import_v49.z.boolean().optional()
});
var CheckParamsSchema2 = import_v49.z.object({
  featureId: import_v49.z.string().optional(),
  productId: import_v49.z.string().optional(),
  entityId: import_v49.z.string().optional(),
  requiredBalance: import_v49.z.number().optional(),
  sendEvent: import_v49.z.boolean().optional(),
  withPreview: import_v49.z.boolean().optional(),
...
var TrackParamsSchema2 = import_v49.z.object({
  featureId: import_v49.z.string().optional(),
  eventName: import_v49.z.string().optional(),
  entityId: import_v49.z.string().optional(),
  value: import_v49.z.number().optional(),
  idempotencyKey: import_v49.z.string().optional(),
  entityData: import_v49.z.any().optional()
});
var OpenBillingPortalParamsSchema = import_v49.z.object({
  returnUrl: import_v49.z.string().optional(),
  openInNewTab: import_v49.z.boolean().optional()
});
var SetupPaymentParamsSchema = import_v49.z.object({
...
var QueryParamsSchema2 = import_v49.z.object({
  featureId: import_v49.z.string().or(import_v49.z.array(import_v49.z.string())),
  range: QueryRangeEnum.optional()
});
